...
public class CourseOperatorAuthenticator implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        String flag = payload.getOrDefault("flag", "courseoperator");
        valid = flag.equals("courseoperator") ? valid : "You do not have permission to access this route";
        
        if(!valid.equalsIgnoreCase("valid") || !flag.equals("courseoperator")){
